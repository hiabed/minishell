...
CFILES = minishell.c syntax_errors.c split.c redirections.c token.c split_spaces.c helpers3.c\
		...
		expand_helpers3.c helpers2.c ./execution/main_ex_helpers.c errors_helper2.c \
