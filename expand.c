...
/*   Updated: 2023/07/11 22:32:02 by mhassani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	g_g.chars = fst_chars(no_quotes, 0);//!    "aaaaa$USER"
	g_g.dollars = print_expanded_dollars(&no_quotes[*i]); //!   $$$USER  $$mhassani;
	...
	if (!temp)
	{
		...
		temp = ft_strjoin_f(temp, after_exp);    //"$dsf'asd"
	}
	else if (temp)
	{
